        ...
        <div class="container">
          <div class="row"> 
           ...
           <!--prix de l'évènement!-->
                    <p>prix</p>
                    <label class="prix:">
                      <input type="number" name="prix" value="Prix:" onFocus="javascript:this.value=''"/>
            ...
            <!--description de l'évènement!-->
                  ...
                  <div class="pull-right">
                    <a href="ajouter.php" class="btn btn_ btn-small_">Tout effacer</a>
                    <input style="background-color:red;" type="submit" class="btn btn_ btn-small_" value="Envoyer">
